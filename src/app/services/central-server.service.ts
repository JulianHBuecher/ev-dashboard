...
export class CentralServerService {
  ...
  public removeChargersFromSiteArea(
    siteAreaID: string,
    chargerIDs: string[]
  ...
  public deleteTransactions(transactionsIDs: number[]): Observable<ActionsResponse> {
    ...
    // Execute the REST service
    return this.httpClient
      .delete<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTIONS), options)
      .pipe(catchError(this.handleHttpError));
  }

  public addChargersToSiteArea(
    siteAreaID: string,
    chargerIDs: string[]
  ): Observable<ActionResponse> {
    // Verify init
  ...
  public removeAssetsFromSiteArea(
    siteAreaID: string,
    assetIDs: string[]
  ): Observable<ActionResponse> {
    // Verify init
  ...
  public removeUsersFromSite(siteID: string, userIDs: string[]): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_SITE_REMOVE_USERS, { id: siteID }),
      { userIDs },
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public getCompanies(
    ...
    // Execute the REST service
    return this.httpClient
      .get<CompanyDataResult>(this.buildRestEndpointUrl(RESTServerRoute.REST_COMPANIES), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getCompany(companyId: string, withLogo: boolean = false): Observable<Company> {
    ...
    // Execute the REST service
    return this.httpClient
      .get<Company>(this.buildRestEndpointUrl(RESTServerRoute.REST_COMPANY, { id: companyId }), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getCompanyLogo(companyID: string): Observable<string> {
    ...
    return this.httpClient
      .get<Blob>(
      this.buildUtilRestEndpointUrl(RESTServerRoute.REST_COMPANY_LOGO, { id: companyID }),
      {
        headers: this.buildHttpHeaders(),
  ...
  public getAssets(
    ...
    // Execute the REST service
    return this.httpClient
      .get<AssetDataResult>(this.buildRestEndpointUrl(RESTServerRoute.REST_ASSETS), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getAsset(
    ...
    // Execute the REST service
    return this.httpClient
      .get<Asset>(this.buildRestEndpointUrl(RESTServerRoute.REST_ASSET, { id: assetId }), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getAssetImage(assetID: string): Observable<string> {
    ...
    // Execute the REST service
    return this.httpClient
      .get<Blob>(this.buildUtilRestEndpointUrl(RESTServerRoute.REST_ASSET_IMAGE, { id: assetID }), {
      headers: this.buildHttpHeaders(),
      responseType: 'blob' as 'json',
      params,
    })
  ...
  public getAssetsInError(
    params: FilterParams,
    paging: Paging = Constants.DEFAULT_PAGING,
    ordering: Ordering[] = []
  ): Observable<AssetInErrorDataResult> {
    // Verify init
    this.checkInit();
    // Build Paging
    this.getPaging(paging, params);
  ...
  public getSiteUsers(
    ...
    // Execute the REST service
    return this.httpClient
      .get<SiteUserDataResult>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_SITE_USERS, { id: params.SiteID as string }),
      {
        headers: this.buildHttpHeaders(),
        params,
      }
  ...
  public getSites(
    ...
    // Execute the REST service
    return this.httpClient
      .get<SiteDataResult>(this.buildRestEndpointUrl(RESTServerRoute.REST_SITES), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public triggerSmartCharging(siteAreaID: string): Observable<ActionResponse> {
    ...
    return this.httpClient
      .get<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATION_TRIGGER_SMART_CHARGING),
      {
        headers: this.buildHttpHeaders(),
        params,
      }
  ...
  public getSite(
    ...
    // Execute the REST service
    return this.httpClient
      .get<Site>(this.buildRestEndpointUrl(RESTServerRoute.REST_SITE, { id: siteID }), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getSiteImage(siteID: string): Observable<string> {
    ...
    // Execute the REST service
    return this.httpClient
      .get<Blob>(this.buildUtilRestEndpointUrl(RESTServerRoute.REST_SITE_IMAGE, { id: siteID }), {
      headers: this.buildHttpHeaders(),
      responseType: 'blob' as 'json',
      params,
    })
  ...
  public getSiteAreas(
    ...
    // Execute the REST service
    return this.httpClient
      .get<SiteAreaDataResult>(this.buildRestEndpointUrl(RESTServerRoute.REST_SITE_AREAS), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getSiteArea(
    ...
    return this.httpClient
      .get<SiteArea>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_SITE_AREA, { id: siteAreaID }),
      {
        headers: this.buildHttpHeaders(),
        params,
      }
  ...
  public getSiteAreaImage(siteAreaID: string): Observable<string> {
    ...
    return this.httpClient
      .get<Blob>(
      this.buildUtilRestEndpointUrl(RESTServerRoute.REST_SITE_AREA_IMAGE, { id: siteAreaID }),
      {
        headers: this.buildHttpHeaders(),
        responseType: 'blob' as 'json',
        params,
  ...
  public getTransactionYears(): Observable<number[]> {
    ...
    // Execute the REST service
    return this.httpClient
      .get<number[]>(this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTION_YEARS), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getChargingStationConsumptionStatistics(
    year: number,
    params: FilterParams = {}
  ): Observable<StatisticDataResult> {
    params['Year'] = year + '';
    // Verify init
    this.checkInit();
    // Execute the REST service
    return this.httpClient
      .get<StatisticDataResult>(
  ...
  public getUserConsumptionStatistics(
    year: number,
    params: FilterParams = {}
  ): Observable<StatisticDataResult> {
    params['Year'] = year + '';
  ...
  public getChargingStationUsageStatistics(
    year: number,
    params: FilterParams = {}
  ): Observable<StatisticDataResult> {
    params['Year'] = year + '';
  ...
  public getChargingStationInactivityStatistics(
    year: number,
    params: FilterParams = {}
  ): Observable<StatisticDataResult> {
    params['Year'] = year + '';
  ...
  public getUserInactivityStatistics(
    year: number,
    params: FilterParams = {}
  ): Observable<StatisticDataResult> {
    params['Year'] = year + '';
  ...
  public getLastTransaction(
    ...
    // Execute the REST service
    return this.httpClient
      .get<TransactionDataResult>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_TRANSACTIONS, {
  ...
  public getChargingStationTransactionsStatistics(
    year: number,
    params: FilterParams = {}
  ): Observable<StatisticDataResult> {
    params['Year'] = year + '';
  ...
  public getUserTransactionsStatistics(
    year: number,
    params: FilterParams = {}
  ): Observable<StatisticDataResult> {
    params['Year'] = year + '';
  ...
  public getChargingStationPricingStatistics(
    year: number,
    params: FilterParams = {}
  ): Observable<StatisticDataResult> {
    params['Year'] = year + '';
  ...
  public getUserPricingStatistics(
    year: number,
    params: FilterParams = {}
  ): Observable<StatisticDataResult> {
    params['Year'] = year + '';
  ...
  public getChargingStations(
    ...
    return this.httpClient
      ...
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS),
      {
        headers: this.buildHttpHeaders(),
        params,
      }
  ...
  public getConnectorQrCode(chargingStationID: string, connectorID: number): Observable<Image> {
    ...
    return this.httpClient
      .get<Image>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_QRCODE_GENERATE, {
        id: chargingStationID,
  ...
  public getChargingStationsInError(
    params: FilterParams,
    paging: Paging = Constants.DEFAULT_PAGING,
    ordering: Ordering[] = []
  ): Observable<ChargingStationInErrorDataResult> {
    // Verify init
    this.checkInit();
    // Build Paging
    this.getPaging(paging, params);
    ...
    // Execute the REST service
    return this.httpClient
      .get<ChargingStationInErrorDataResult>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_IN_ERROR),
      {
        headers: this.buildHttpHeaders(),
        params,
      }
  ...
  public getUserSites(
    ...
    // Execute the REST service
    return this.httpClient
      .get<UserSiteDataResult>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_USER_SITES, {
  ...
  public getUsers(
    ...
    // Execute the REST service
    return this.httpClient
      .get<UserDataResult>(this.buildRestEndpointUrl(RESTServerRoute.REST_USERS), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getTagByVisualID(tagVisualID: string): Observable<Tag> {
    ...
    // Execute the REST service
    return this.httpClient
      .get<Tag>(this.buildRestEndpointUrl(RESTServerRoute.REST_TAGS), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getUserSessionContext(
    userID: string,
    chargingStationID: string,
    connectorID: number
  ): Observable<UserSessionContext> {
    // Verify init
    this.checkInit();
    return this.httpClient
      .get<UserSessionContext>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_USER_SESSION_CONTEXT, { id: userID }),
      {
        headers: this.buildHttpHeaders(),
        params: {
  ...
  public getTags(
    ...
    // Execute the REST service
    return this.httpClient
      .get<TagDataResult>(this.buildRestEndpointUrl(RESTServerRoute.REST_TAGS), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public deleteTags(tagsIDs: string[]): Observable<ActionsResponse> {
    ...
    // Execute the REST service
    return this.httpClient
      .delete<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_TAGS), options)
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public unassignTags(visualIDs: string[]): Observable<ActionsResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_TAGS_UNASSIGN),
      { visualIDs },
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public unassignTag(visualID: string): Observable<ActionsResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_TAG_UNASSIGN, { id: visualID }),
      {},
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public createTag(tag: Tag): Observable<ActionResponse> {
    ...
    // Execute the REST service
    return this.httpClient
      .post<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_TAGS), tag, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public assignTag(tag: Partial<Tag>): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_TAG_ASSIGN, { id: tag.visualID }),
      tag,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public getUsersInError(
    ...
    // Execute the REST service
    return this.httpClient
      .get<UserDataResult>(this.buildRestEndpointUrl(RESTServerRoute.REST_USERS_IN_ERROR), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getTenants(
    ...
    // Execute the REST service
    return this.httpClient
      .get<DataResult<Tenant>>(this.buildRestEndpointUrl(RESTServerRoute.REST_TENANTS), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getTenant(id: string): Observable<Tenant> {
    ...
    // Execute the REST service
    return this.httpClient
      .get<Tenant>(this.buildRestEndpointUrl(RESTServerRoute.REST_TENANT, { id }), {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public getTenantLogo(tenantID: string): Observable<string> {
    ...
    // Execute the REST service
    return this.httpClient
      .get<Blob>(this.buildUtilRestEndpointUrl(RESTServerRoute.REST_TENANT_LOGO), {
      headers: this.buildHttpHeaders(),
      responseType: 'blob' as 'json',
      params,
    })
  ...
  public getTransactionsToRefund(
    params: FilterParams,
    paging: Paging = Constants.DEFAULT_PAGING,
    ordering: Ordering[] = []
  ): Observable<TransactionDataResult> {
  ...
  public getRefundReports(
    params: FilterParams,
    paging: Paging = Constants.DEFAULT_PAGING,
    ordering: Ordering[] = []
  ): Observable<DataResult<RefundReport>> {
    // Verify init
    this.checkInit();
    // Build Paging
    this.getPaging(paging, params);
  ...
  public exportTransactionOcpiCdr(id: number): Observable<OcpiData> {
    ...
    return this.httpClient
      .get<OcpiData>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTION_CDR_EXPORT, { id }),
      {
        headers: this.buildHttpHeaders(),
      }
    )
  ...
  public getTransaction(id: number): Observable<Transaction> {
    ...
    // Execute the REST service
    return this.httpClient
      .get<Transaction>(this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTION, { id }), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public exportLogs(params: FilterParams): Observable<Blob> {
    this.checkInit();
    return this.httpClient
      .get(this.buildRestEndpointUrl(RESTServerRoute.REST_LOGS_EXPORT), {
        headers: this.buildHttpHeaders(),
        responseType: 'blob',
        params,
      })
  ...
  public exportUsers(params: FilterParams): Observable<Blob> {
    this.checkInit();
    return this.httpClient
      .get(this.buildRestEndpointUrl(RESTServerRoute.REST_USERS_EXPORT), {
        headers: this.buildHttpHeaders(),
        responseType: 'blob',
        params,
      })
  ...
  public exportTransactions(params: FilterParams): Observable<Blob> {
    this.checkInit();
    return this.httpClient
      .get(this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTIONS_EXPORT), {
        headers: this.buildHttpHeaders(),
        responseType: 'blob',
        params,
      })
  ...
  public exportTransactionsToRefund(params: FilterParams): Observable<Blob> {
    this.checkInit();
    return this.httpClient
      .get(this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTIONS_REFUND_EXPORT), {
        headers: this.buildHttpHeaders(),
        responseType: 'blob',
        params,
      })
  ...
  public exportStatistics(params: FilterParams): Observable<Blob> {
    this.checkInit();
    return this.httpClient
      .get(this.buildRestEndpointUrl(RESTServerRoute.REST_STATISTICS_EXPORT), {
        headers: this.buildHttpHeaders(),
        responseType: 'blob',
        params,
      })
  ...
  public exportChargingStations(params: FilterParams): Observable<Blob> {
    this.checkInit();
    return this.httpClient
      .get(this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_EXPORT), {
        headers: this.buildHttpHeaders(),
        responseType: 'blob',
        params,
      })
  ...
  public exportAllChargingStationsOCPPParams(params: FilterParams): Observable<Blob> {
    ...
    return this.httpClient
      .get(
        this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_EXPORT_OCPP_PARAMETERS),
        {
          headers: this.buildHttpHeaders(),
          responseType: 'blob',
          params,
  ...
  public getTransactionsInError(
    params: FilterParams,
    paging: Paging = Constants.DEFAULT_PAGING,
    ordering: Ordering[] = []
  ): Observable<TransactionInErrorDataResult> {
    // Verify init
    this.checkInit();
    // Build Paging
    this.getPaging(paging, params);
    ...
    // Execute the REST service
    return this.httpClient
      .get<TransactionInErrorDataResult>(
  ...
  public getOcpiEndpoints(
    ...
    // Execute the REST service
    return this.httpClient
      .get<OcpiEndpointDataResult>(this.buildRestEndpointUrl(RESTServerRoute.REST_OCPI_ENDPOINTS), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  // eslint-disable-next-line max-len
  public getOicpEndpoints(
    params: FilterParams,
    paging: Paging = Constants.DEFAULT_PAGING,
    ordering: Ordering[] = []
  ): Observable<DataResult<OicpEndpoint>> {
    // Verify init
    this.checkInit();
    // Build Paging
    this.getPaging(paging, params);
  ...
  public getSiteAreaConsumption(
    siteAreaID: string,
    startDate: Date,
    endDate: Date
  ): Observable<SiteAreaConsumption> {
    const params: { [param: string]: string } = {};
  ...
  public getAssetConsumption(
    assetID: string,
    startDate: Date,
    endDate: Date
  ): Observable<AssetConsumption> {
    const params: { [param: string]: string } = {};
    params['StartDate'] = startDate.toISOString();
    params['EndDate'] = endDate.toISOString();
    // Verify init
    ...
    // Execute the REST service
    return this.httpClient
      .get<AssetConsumption>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_ASSET_CONSUMPTIONS, { id: assetID }),
      {
        headers: this.buildHttpHeaders(),
        params,
      }
  ...
  public getTransactionConsumption(
  ...
  public createTenant(tenant: Tenant): Observable<ActionResponse> {
    ...
    // Execute the REST service
    return this.httpClient
      .post<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_TENANTS), tenant, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public updateTenant(tenant: Tenant): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_TENANT, { id: tenant.id }),
      tenant,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public updateTenantData(tenant: Tenant): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_TENANT_DATA, { id: tenant.id }),
      tenant,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public deleteTenant(id: string): Observable<ActionResponse> {
    ...
    // Execute the REST service
    return this.httpClient
      .delete<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_TENANT, { id }), {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public getLogs(
    ...
    // Execute the REST service
    return this.httpClient
      .get<LogDataResult>(this.buildRestEndpointUrl(RESTServerRoute.REST_LOGS), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getLog(id: string): Observable<Log> {
    ...
    // Call
    return this.httpClient
      .get<Log>(this.buildRestEndpointUrl(RESTServerRoute.REST_LOG, { id }), {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public getSetting(identifier: string): Observable<SettingDB> {
    ...
    // Execute the REST Service
    return this.httpClient
      .get<SettingDB>(this.buildRestEndpointUrl(RESTServerRoute.REST_SETTINGS), {
      headers: this.buildHttpHeaders(),
      params: {
  ...
  public updateBillingSettings(billingSettings: BillingSettings): Observable<ActionResponse> {
    ...
    // Execute
    return this.httpClient
      .put<ActionResponse>(url, billingSettings, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public checkBillingConnection(): Observable<CheckBillingConnectionResponse> {
    ...
    // Execute the REST Service
    return this.httpClient
      .post<CheckBillingConnectionResponse>(
      url,
      {},
      {
        headers: this.buildHttpHeaders(),
  ...
  public setupPaymentMethod(parameters: any): Observable<BillingOperationResult> {
    ...
    // Execute the REST service
    return this.httpClient
      .post<BillingOperationResult>(url, parameters, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public getPaymentMethods(
    ...
    paging: Paging = Constants.DEFAULT_PAGING,
    ordering: Ordering[] = []
  ): Observable<BillingPaymentMethodDataResult> {
    // Verify init
    this.checkInit();
    // Build Paging
    this.getPaging(paging, params);
    ...
    // Execute the REST Service
    return this.httpClient
      .get<BillingPaymentMethodDataResult>(url, {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public deletePaymentMethod(
    ...
    userID: string
  ): Observable<BillingOperationResult> {
    // Verify init
    this.checkInit();
    const options = {
      headers: this.buildHttpHeaders(),
    ...
    // Execute the REST service
    return this.httpClient
      .delete<BillingOperationResult>(url, options)
      .pipe(catchError(this.handleHttpError));
  }

  public forceSynchronizeUserForBilling(userID: string): Observable<ActionResponse> {
    const url = this.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_USER_SYNCHRONIZE, {
      id: userID,
    });
    return this.httpClient
      .patch<ActionResponse>(
      url,
      {},
      {
        headers: this.buildHttpHeaders(),
  ...
  public createBillingAccount(account: BillingAccount): Observable<ActionResponse> {
    ...
    return this.httpClient
      .post<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_ACCOUNTS),
      account,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public getBillingAccounts(
    ...
    // Execute the REST Service
    return this.httpClient
      .get<BillingAccountDataResult>(url, {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public refreshBillingAccount(tenantID: string, accountID: string): Observable<BillingAccount> {
    ...
    const url = this.buildUtilRestEndpointUrl(RESTServerRoute.REST_BILLING_ACCOUNT_REFRESH, {
      id: accountID,
    });
    return this.httpClient
      .patch<ActionResponse>(url, params, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public activateBillingAccount(tenantID: string, accountID: string): Observable<BillingAccount> {
    this.checkInit();
    const params: { [param: string]: string } = { TenantID: tenantID };
    const url = this.buildUtilRestEndpointUrl(RESTServerRoute.REST_BILLING_ACCOUNT_ACTIVATE, {
      id: accountID,
    });
    return this.httpClient
      .patch<ActionResponse>(url, params, {
  ...
  public getInvoices(
    ...
    paging: Paging = Constants.DEFAULT_PAGING,
    ordering: Ordering[] = []
  ): Observable<BillingInvoiceDataResult> {
    // Verify init
    this.checkInit();
    // Build Paging
    this.getPaging(paging, params);
    ...
    // Execute the REST Service
    return this.httpClient
      .get<BillingInvoiceDataResult>(url, {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public downloadSiteQrCodes(siteID: string): Observable<Blob> {
    ...
    return this.httpClient
      .get(this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_QRCODE_DOWNLOAD), {
        headers: this.buildHttpHeaders(),
        params,
        responseType: 'blob',
      })
  ...
  public downloadChargingStationQrCodes(
    chargingStationID: string,
    connectorID?: number
  ): Observable<Blob> {
    this.checkInit();
  ...
  public getRegistrationTokens(
    params: FilterParams,
    paging: Paging = Constants.DEFAULT_PAGING,
    ordering: Ordering[] = []
  ): Observable<RegistrationTokenDataResult> {
    // Verify init
    this.checkInit();
    // Build Paging
    this.getPaging(paging, params);
    ...
    // Execute the REST service
    return this.httpClient
      .get<RegistrationTokenDataResult>(
  ...
  public getRegistrationToken(registrationTokenID: string): Observable<RegistrationToken> {
    ...
    return this.httpClient
      ...
      this.buildRestEndpointUrl(RESTServerRoute.REST_REGISTRATION_TOKEN, {
  ...
  public revokeRegistrationToken(id: string): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_REGISTRATION_TOKEN_REVOKE, { id }),
      {},
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public getEndUserLicenseAgreement(language: string): Observable<EndUserLicenseAgreement> {
    ...
    return this.httpClient
      ...
      `${this.restServerAuthURL}/${RESTServerRoute.REST_END_USER_LICENSE_AGREEMENT}`,
      {
  ...
  public getTransfers(
    ...
    paging: Paging = Constants.DEFAULT_PAGING,
    ordering: Ordering[] = []
  ): Observable<BillingTransferDataResult> {
    // Verify init
    this.checkInit();
    // Build Paging
    this.getPaging(paging, params);
    ...
    // Execute the REST Service
    return this.httpClient
      .get<BillingTransferDataResult>(url, {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public finalizeTransfer(transferID: string): Observable<ActionResponse> {
    this.checkInit();
    const url = this.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_TRANSFER_FINALIZE, {
      id: transferID,
    });
    return this.httpClient
      .patch<ActionResponse>(
  ...
  public sendTransfer(transferID: string): Observable<ActionResponse> {
    this.checkInit();
    const url = this.buildRestEndpointUrl(RESTServerRoute.REST_BILLING_TRANSFER_SEND, {
      id: transferID,
    });
    return this.httpClient
      .patch<ActionResponse>(
  ...
  public login(user: any): Observable<LoginResponse> {
    ...
    // Execute
    return this.httpClient
      .post<LoginResponse>(`${this.restServerAuthURL}/${RESTServerRoute.REST_SIGNIN}`, user, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public isAuthenticated(): boolean {
    return (
      this.getLoggedUserToken() && !new JwtHelperService().isTokenExpired(this.getLoggedUserToken())
    );
  }
  ...
  public logout(): Observable<ActionResponse> {
    ...
    // Execute the REST service
    return this.httpClient
      .get<ActionResponse>(`${this.restServerAuthURL}/${RESTServerRoute.REST_SIGNOUT}`, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public resetUserPassword(data: any): Observable<ActionResponse> {
    ...
    return this.httpClient
      .post<ActionResponse>(
      `${this.restServerAuthURL}/${RESTServerRoute.REST_PASSWORD_RESET}`,
      data,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public registerUser(user: any): Observable<ActionResponse> {
    ...
    // Execute
    return this.httpClient
      .post<ActionResponse>(`${this.restServerAuthURL}/${RESTServerRoute.REST_SIGNON}`, user, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public createUser(user: any): Observable<ActionResponse> {
    ...
    // Execute
    return this.httpClient
      .post<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_USERS), user, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public createCompany(company: any): Observable<ActionResponse> {
    ...
    // Execute
    return this.httpClient
      .post<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_COMPANIES), company, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public updateCompany(company: Company): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_COMPANY, { id: company.id }),
      company,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public deleteCompany(id: string): Observable<ActionResponse> {
    ...
    // Execute the REST service
    return this.httpClient
      .delete<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_COMPANY, { id }), {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public createAsset(asset: any): Observable<ActionResponse> {
    ...
    // Execute
    return this.httpClient
      .post<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_ASSETS), asset, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public updateAsset(asset: Asset): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_ASSET, { id: asset.id }),
      asset,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public deleteAsset(id: string): Observable<ActionResponse> {
    ...
    // Execute the REST service
    return this.httpClient
      .delete<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_ASSET, { id }), {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public checkAssetConnection(assetConnectionId: string): Observable<CheckAssetConnectionResponse> {
    ...
    return this.httpClient
      .get<CheckAssetConnectionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_ASSET_CHECK_CONNECTION, {
        id: assetConnectionId,
      }),
      {
        headers: this.buildHttpHeaders(),
        params,
  ...
  public tableRetrieveAssetConsumptionAction(assetId: string): Observable<ActionResponse> {
    ...
    return this.httpClient
      .get<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_ASSET_RETRIEVE_CONSUMPTION, { id: assetId }),
      {
        headers: this.buildHttpHeaders(),
        params,
      }
  ...
  public createSite(site: Site): Observable<ActionResponse> {
    ...
    // Execute
    return this.httpClient
      .post<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_SITES), site, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public updateSite(site: Site): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_SITE, { id: site.id }),
      site,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public deleteSite(id: string): Observable<ActionResponse> {
    ...
    // Execute the REST service
    return this.httpClient
      .delete<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_SITE, { id }), {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }

  public createSiteArea(
    siteArea: SiteArea,
  ...
  public updateSiteArea(
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_SITE_AREA, { id: siteArea.id }),
      {
        ...siteArea,
        subSiteAreasAction: subSiteAreaActions.join('|'),
      },
  ...
  public deleteSiteArea(id: string): Observable<ActionResponse> {
    ...
    // Execute the REST service
    return this.httpClient
      .delete<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_SITE_AREA, { id }), {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public updateSetting(setting: SettingDB): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_SETTING, { id: setting.id }),
      setting,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public sendEVSEStatusesOcpiEndpoint(
    ocpiEndpoint: OCPIEndpoint
  ): Observable<OCPIJobStatusesResponse> {
    // Verify init
    this.checkInit();
    // Execute
    return this.httpClient
      .put<OCPIJobStatusesResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OCPI_ENDPOINT_SEND_EVSE_STATUSES, {
        id: ocpiEndpoint.id,
      }),
      {},
      {
  ...
  public sendTokensOcpiEndpoint(ocpiEndpoint: OCPIEndpoint): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<OCPIJobStatusesResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OCPI_ENDPOINT_SEND_TOKENS, {
        id: ocpiEndpoint.id,
      }),
      {},
      {
  ...
  public pullLocationsOcpiEndpoint(
    ocpiEndpoint: OCPIEndpoint
  ): Observable<OCPIJobStatusesResponse> {
    // Verify init
    this.checkInit();
    ...
    return this.httpClient
      .put<OCPIJobStatusesResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OCPI_ENDPOINT_PULL_LOCATIONS, {
        id: ocpiEndpoint.id,
      }),
      {},
      {
  ...
  public pullSessionsOcpiEndpoint(ocpiEndpoint: OCPIEndpoint): Observable<OCPIJobStatusesResponse> {
    ...
    return this.httpClient
      .put<OCPIJobStatusesResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OCPI_ENDPOINT_PULL_SESSIONS, {
        id: ocpiEndpoint.id,
      }),
      {},
      {
  ...
  public pullTokensOcpiEndpoint(ocpiEndpoint: OCPIEndpoint): Observable<OCPIJobStatusesResponse> {
    ...
    return this.httpClient
      .put<OCPIJobStatusesResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OCPI_ENDPOINT_PULL_TOKENS, {
        id: ocpiEndpoint.id,
      }),
      {},
      {
  ...
  public pullCdrsOcpiEndpoint(ocpiEndpoint: OCPIEndpoint): Observable<OCPIJobStatusesResponse> {
    ...
    return this.httpClient
      .put<OCPIJobStatusesResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OCPI_ENDPOINT_PULL_CDRS, {
        id: ocpiEndpoint.id,
      }),
      {},
      {
  ...
  public checkLocationsOcpiEndpoint(
    ocpiEndpoint: OCPIEndpoint
  ): Observable<OCPIJobStatusesResponse> {
    // Verify init
    this.checkInit();
    ...
    return this.httpClient
      .put<OCPIJobStatusesResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OCPI_ENDPOINT_CHECK_LOCATIONS, {
        id: ocpiEndpoint.id,
      }),
      {},
      {
  ...
  public checkCdrsOcpiEndpoint(ocpiEndpoint: OCPIEndpoint): Observable<OCPIJobStatusesResponse> {
    ...
    return this.httpClient
      .put<OCPIJobStatusesResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OCPI_ENDPOINT_CHECK_CDRS, {
        id: ocpiEndpoint.id,
      }),
      {},
      {
  ...
  public checkSessionsOcpiEndpoint(
    ocpiEndpoint: OCPIEndpoint
  ): Observable<OCPIJobStatusesResponse> {
    // Verify init
    this.checkInit();
    ...
    return this.httpClient
      .put<OCPIJobStatusesResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OCPI_ENDPOINT_CHECK_SESSIONS, {
        id: ocpiEndpoint.id,
      }),
      {},
      {
  ...
  public sendEVSEStatusesOicpEndpoint(
    oicpEndpoint: OicpEndpoint
  ): Observable<OICPJobStatusesResponse> {
    // Verify init
    this.checkInit();
    // Execute
    return this.httpClient
      .put<OICPJobStatusesResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OICP_ENDPOINT_SEND_EVSE_STATUSES, {
        id: oicpEndpoint.id,
      }),
      {},
      {
  ...
  public sendEVSEsOicpEndpoint(oicpEndpoint: OicpEndpoint): Observable<OICPJobStatusesResponse> {
    ...
    return this.httpClient
      .put<OICPJobStatusesResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OICP_ENDPOINT_SEND_EVSES, {
        id: oicpEndpoint.id,
      }),
      {},
      {
  ...
  public pingOicpEndpoint(oicpEndpoint: any): Observable<OICPPingResponse> {
    ...
    // Execute
    return this.httpClient
      .put<OICPPingResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OICP_ENDPOINT_PING, { id: oicpEndpoint.id }),
      oicpEndpoint,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public updateOicpEndpoint(oicpEndpoint: OicpEndpoint): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OICP_ENDPOINT, { id: oicpEndpoint.id }),
      oicpEndpoint,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public pingOcpiEndpoint(ocpiEndpoint: any): Observable<OCPIPingResponse> {
    ...
    // Execute
    return this.httpClient
      .put<OCPIPingResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OCPI_ENDPOINT_PING, { id: ocpiEndpoint.id }),
      ocpiEndpoint,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public generateLocalTokenOcpiEndpoint(
    ocpiEndpoint: OCPIEndpoint
  ): Observable<OCPIGenerateLocalTokenResponse> {
    // Verify init
    this.checkInit();
    // Execute
    return this.httpClient
      .put<OCPIGenerateLocalTokenResponse>(
  ...
  public updateOcpiEndpoint(ocpiEndpoint: OCPIEndpoint): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_OCPI_ENDPOINT, { id: ocpiEndpoint.id }),
      ocpiEndpoint,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public verifyEmail(params: FilterParams): Observable<ActionResponse> {
    ...
    // Execute the REST service
    return this.httpClient
      .get<ActionResponse>(`${this.restServerAuthURL}/${RESTServerRoute.REST_MAIL_CHECK}`, {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public resendVerificationEmail(user: any): Observable<ActionResponse> {
    ...
    // Execute
    return this.httpClient
      .post<ActionResponse>(`${this.restServerAuthURL}/${RESTServerRoute.REST_MAIL_RESEND}`, user, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public deleteTransaction(id: number): Observable<ActionResponse> {
    ...
    // Execute the REST service
    return this.httpClient
      .delete<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTION, { id }), {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public refundTransactions(ids: number[]): Observable<ActionsResponse> {
    ...
    return this.httpClient
      .post<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTIONS_REFUND_ACTION),
      { transactionIds: ids },
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public pushTransactionCdr(id: number): Observable<ActionsResponse> {
    ...
    return this.httpClient
      .post<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTION_CDR, { id }),
      {},
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public synchronizeRefundedTransactions(): Observable<ActionResponse> {
    ...
    return this.httpClient
      .post<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTIONS_SYNCHRONIZE_REFUNDED),
      {},
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public stopTransaction(id: number): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTION_STOP, { id }),
      {},
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public softStopTransaction(id: number): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_TRANSACTION_SOFT_STOP, { id }),
      {},
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public chargingStationStopTransaction(
    chargingStationID: string,
    transactionId: number
  ): Observable<ActionResponse> {
    this.checkInit();
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_REMOTE_STOP, {
        id: chargingStationID,
      }),
      body,
      {
  ...
  public chargingStationsUnlockConnector(
    chargingStationID: string,
    connectorId: number
  ): Observable<ActionResponse> {
    this.checkInit();
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_UNLOCK_CONNECTOR, {
        id: chargingStationID,
        connectorId,
      }),
      {},
  ...
  public chargingStationStartTransaction(
    chargingStationID: string,
    connectorId: number,
    userID: string,
    visualTagID: string,
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_REMOTE_START, {
        id: chargingStationID,
      }),
      body,
      {
  ...
  public updateChargingStationParams(chargingStation: ChargingStation): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_UPDATE_PARAMETERS, {
  ...
  public updateChargingProfile(chargingProfile: ChargingProfile): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_PROFILE, {
  ...
  public getChargingStationOcppParameters(
    chargingStationID: string
  ): Observable<DataResult<OcppParameter>> {
    // Verify Init
    this.checkInit();
    // Execute REST Service
    return this.httpClient
      .get<DataResult<OcppParameter>>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATION_GET_OCPP_PARAMETERS, {
        id: chargingStationID,
      }),
      {
        headers: this.buildHttpHeaders(),
  ...
  public getCarCatalogs(
    params: FilterParams,
    paging: Paging = Constants.DEFAULT_PAGING,
    ordering: Ordering[] = []
  ): Observable<CarCatalogDataResult> {
    // Verify init
    this.checkInit();
    // Build Paging
    this.getPaging(paging, params);
    ...
    // Execute the REST service
    return this.httpClient
      .get<CarCatalogDataResult>(this.buildRestEndpointUrl(RESTServerRoute.REST_CAR_CATALOGS), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getCars(
    ...
    // Execute the REST service
    return this.httpClient
      .get<CarDataResult>(this.buildRestEndpointUrl(RESTServerRoute.REST_CARS), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getCar(carID: string): Observable<Car> {
    ...
    // Execute the REST service
    return this.httpClient
      .get<Car>(this.buildRestEndpointUrl(RESTServerRoute.REST_CAR, { id: carID }), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getCarCatalog(id: number): Observable<CarCatalog> {
    ...
    // Execute the REST service
    return this.httpClient
      .get<CarCatalog>(this.buildRestEndpointUrl(RESTServerRoute.REST_CAR_CATALOG, { id }), {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }

  public getCarCatalogImages(
    id: number,
    params: FilterParams,
    paging: Paging = Constants.DEFAULT_PAGING
  ): Observable<DataResult<ImageObject>> {
    // Verify init
    this.checkInit();
    // Build Paging
    this.getPaging(paging, params);
  ...
  public getCarMakers(params: FilterParams): Observable<DataResult<CarMaker>> {
    ...
    // Execute the REST service
    return this.httpClient
      .get<DataResult<CarMaker>>(this.buildRestEndpointUrl(RESTServerRoute.REST_CAR_MAKERS), {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public synchronizeCarsCatalog(): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CAR_CATALOG_SYNCHRONIZE),
      {},
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public updateCar(car: Car): Observable<ActionResponse> {
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CAR, { id: car.id }),
      car,
      {
        headers: this.buildHttpHeaders(),
      }
  ...
  public deleteCar(id: number): Observable<ActionResponse> {
    ...
    // Execute the REST service
    return this.httpClient
      .delete<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_CAR, { id }), {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }

  public updateChargingStationOCPPConfiguration(
    id: string,
    chargerParameter: KeyValue
  ): Observable<ActionResponse> {
    // Verify init
    this.checkInit();
    // Execute the REST service
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_CHANGE_CONFIGURATION, {
        id,
      }),
      body,
      {
  ...
  public getChargingStationCompositeSchedule(
    id: string,
    connectorId: number,
    duration: number,
    unit: string
    ...
    // Execute
    return this.httpClient
      .put<GetCompositeScheduleCommandResult | GetCompositeScheduleCommandResult[]>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_GET_COMPOSITE_SCHEDULE, {
        id,
      }),
      body,
      {
  ...
  public chargingStationLimitPower(
    ...
    connectorId?: number,
    ampLimitValue: number = 0,
    forceUpdateChargingPlan: boolean = false
  ): Observable<ActionResponse> {
    // Verify init
    this.checkInit();
    // Execute
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_POWER_LIMIT, {
        id: charger.id,
      }),
      {
  ...
  public chargingStationSetChargingProfile(
    charger: ChargingStation,
    connectorId: number,
    chargingProfile: any
  ): Observable<ActionResponse> {
  ...
  public chargingStationUpdateFirmware(
    charger: ChargingStation,
    locationURL: string
  ): Observable<ActionResponse> {
    // Verify init
    ...
    return this.httpClient
      .put<ActionResponse>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATIONS_FIRMWARE_UPDATE, {
        id: charger.id,
      }),
      body,
      {
  ...
  public chargingStationChangeAvailability(
    id: string,
    available: boolean,
    connectorID: number = 0
  ): Observable<ActionResponse> {
    return this.actionChargingStation(
      `${RESTServerRoute.REST_CHARGING_STATIONS}/${id}/availability/change`,
      JSON.stringify({
        connectorId: connectorID,
  ...
  public chargingStationReset(id: string, hard: boolean = false): Observable<ActionResponse> {
    return this.actionChargingStation(
      `${RESTServerRoute.REST_CHARGING_STATIONS}/${id}/reset`,
      JSON.stringify({ type: hard ? OCPPResetType.HARD : OCPPResetType.SOFT })
    );
  }

  public chargingStationClearCache(id: string): Observable<ActionResponse> {
    return this.actionChargingStation(
      `${RESTServerRoute.REST_CHARGING_STATIONS}/${id}/cache/clear`,
      ''
    );
  }
  ...
  public actionChargingStation(action: string, args: string): Observable<ActionResponse> {
    ...
    // Execute
    return this.httpClient
      .put<ActionResponse>(`${this.restServerSecuredURL}/${action}`, body, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public getIntegrationConnections(userId: string): Observable<DataResult<IntegrationConnection>> {
    this.checkInit();
    return this.httpClient
      .get<DataResult<IntegrationConnection>>(
      this.buildRestEndpointUrl(RESTServerRoute.REST_CONNECTIONS),
      {
        params: {
          UserID: userId,
        },
  ...
  public deleteIntegrationConnection(id: string): Observable<ActionResponse> {
    this.checkInit();
    return this.httpClient
      .delete<ActionResponse>(this.buildRestEndpointUrl(RESTServerRoute.REST_CONNECTION, { id }), {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public createPricingDefinition(pricingDefinition: PricingDefinition): Observable<ActionResponse> {
    ...
    return this.httpClient
      .post<ActionResponse>(url, pricingDefinition, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public getPricingDefinition(id: string): Observable<PricingDefinition> {
    ...
    return this.httpClient
      .get<PricingDefinition>(url, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }

  public getPricingDefinitions(
    params: FilterParams,
    paging: Paging = Constants.DEFAULT_PAGING,
    ordering: Ordering[] = [],
    context?: { entityID: string; entityType: string }
  ): Observable<PricingDefinitionDataResult> {
    // Verify init
    this.checkInit();
    // Build Paging
    this.getPaging(paging, params);
    ...
    // Execute the REST service
    return this.httpClient
      .get<PricingDefinitionDataResult>(url, {
      headers: this.buildHttpHeaders(),
      params: {
        ...params,
      },
  ...
  public updatePricingDefinition(pricingDefinition: PricingDefinition): Observable<ActionResponse> {
    ...
    this.checkInit();
    // Execute the REST service
    const url = this.buildRestEndpointUrl(RESTServerRoute.REST_PRICING_DEFINITION, {
      id: pricingDefinition.id,
    });
    return this.httpClient
      .put<ActionResponse>(url, pricingDefinition, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public deletePricingDefinition(id: string) {
    ...
    // Execute the REST service
    return this.httpClient
      .delete<ActionResponse>(url, params)
      .pipe(catchError(this.handleHttpError));
  }

  public getChargingStationTemplates(
    params: FilterParams,
    paging: Paging = Constants.DEFAULT_PAGING,
    ordering: Ordering[] = []
  ): Observable<ChargingStationTemplateDataResult> {
    // Verify init
    this.checkInit();
    // Build Paging
    this.getPaging(paging, params);
    ...
    // Execute the REST service
    return this.httpClient
      .get<ChargingStationTemplateDataResult>(url, {
      headers: this.buildHttpHeaders(),
      params,
    })
      .pipe(catchError(this.handleHttpError));
  ...
  public getChargingStationTemplate(id: string): Observable<ChargingStationTemplate> {
    ...
    return this.httpClient
      .get<ChargingStationTemplate>(url, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }

  public createChargingStationTemplate(
    ...
    // Execute the REST service
    return this.httpClient
      .post<ActionResponse>(url, template, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }

  public updateChargingStationTemplate(
    template: ChargingStationTemplate
  ): Observable<ActionResponse> {
    // Verify init
    this.checkInit();
    const url = this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATION_TEMPLATE, {
      id: template.id,
    });
    // Execute
    return this.httpClient
      .put<ActionResponse>(url, template, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public deleteChargingStationTemplate(id: string): Observable<ChargingStationTemplate> {
    ...
    const url = this.buildRestEndpointUrl(RESTServerRoute.REST_CHARGING_STATION_TEMPLATE, { id });
    return this.httpClient
      .delete<ChargingStationTemplate>(url, {
      headers: this.buildHttpHeaders(),
    })
      .pipe(catchError(this.handleHttpError));
  }
  ...
  public buildRestEndpointUrl(
    ...
    urlPrefix = this.restServerSecuredURL
  ): string {
