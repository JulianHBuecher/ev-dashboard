...
@Component({
  template: '<app-reservation #appRef [reservationId]="reservationId" [dialogMode]="dialogMode" [dialogRef]="dialogRef" [reservationsAuthorizations]="reservationsAuthorizations" ></app-reservation>'
})
